...
cubeculator.controller("myCubaticaCtrl", function($scope) {
	...
	$scope.options = [
		...
		{id:3,title:'Daily Optimization',info:'Place text here for more information',mod:'Daily optimizations',metric:'Sales',needed:[{id:0,label:'Yes',answer:false},{id:1,label:'No',answer:false},{id:2,label:'Maybe',answer:false},{id:3,label:'I\'m supposed to optimize?',answer:false}],best:10,expected:5,worst:2,timeframeb:6,timeframee:12,timeframew:18},
