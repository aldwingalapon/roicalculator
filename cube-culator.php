						...
						<div class="col-md-8">
							...
							<div data-ng-repeat="x in options">
								<div class="option-item" id="option{{$index + 1}}">
									<div class="option-header">{{$index + 1}}. {{x.title}} <span class="info" data-toggle="tooltip" data-placement="top" title="{{x.info}}"></span><div class="field_error"><div class="error_message_outer"><div class="error_message_content">{{x.error}}</div></div></div></div>
